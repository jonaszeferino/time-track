...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Erro ao buscar empregados', details: error instanceof Error ? error.message : String(error) }, { status: 500 })
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Erro ao criar empregado' }, { status: 500 })
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Erro ao atualizar empregado' }, { status: 500 })
  }
}

// DELETE - Soft delete de empregado
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Erro ao deletar empregado' }, { status: 500 })
  }
}
